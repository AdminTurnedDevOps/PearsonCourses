...
const StatefulSetsAccordions = ({}) => {
  ...
  return /* @__PURE__ */ React__default.createElement(
    ...
    groupedResponses.statefulsets.map((statefulset, i) => /* @__PURE__ */ React__default.createElement(Grid, { container: true, item: true, key: i, xs: true }, /* @__PURE__ */ React__default.createElement(Grid, { item: true, xs: true }, /* @__PURE__ */ React__default.createElement(

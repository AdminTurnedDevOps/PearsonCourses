...
var Standalone_1 = __importDefault(require("./Standalone"));
    ...
    AsyncApiComponent.prototype.parseSchema = function (schema, parserOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        parsedSpec = helpers_1.SpecificationHelpers.retrieveParsedSpec(schema);
                        if (parsedSpec) {
                            this.setState({
                                asyncapi: parsedSpec,
                            });
                        ...
                        if (!(0, types_1.isFetchingSchemaInterface)(schema)) return [3, 2];
                        return [4, helpers_1.Parser.parseFromUrl(schema, parserOptions)];
                    case 1:
                        ...
                        return [2];
                    case 2: return [4, helpers_1.Parser.parse(schema, parserOptions)];
                    case 3:
                        parsed = _a.sent();
                        this.setState({

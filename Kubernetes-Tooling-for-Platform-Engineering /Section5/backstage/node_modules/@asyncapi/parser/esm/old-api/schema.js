...
export class Schema extends SpecificationExtensionsModel {
    uid() {
    ...
    properties() {
        return createMapOfType(this.__get('properties'), Schema, { parent: this });
    }
    property(name) {
        return getMapValue(this.__get('properties'), name, Schema, { parent: this });
    }
    ...
    patternProperties() {
        return createMapOfType(this.__get('patternProperties'), Schema, { parent: this });
    }
    const() {
    ...
    definitions() {
        return createMapOfType(this.__get('definitions'), Schema, { parent: this });
    }
    title() {

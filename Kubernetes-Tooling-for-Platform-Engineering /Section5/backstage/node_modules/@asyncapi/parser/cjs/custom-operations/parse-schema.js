...
exports.parseSchemasV3 = exports.parseSchemasV2 = void 0;
...
function parseSchemasV3(parser, detailed) {
    return __awaiter(this, void 0, void 0, function* () {
        const defaultSchemaFormat = (0, schema_parser_1.getDefaultSchemaFormat)(detailed.semver.version);
        const parseItems = [];
        const visited = new Set();
        customSchemasPathsV3.forEach(path => {
            (0, jsonpath_plus_1.JSONPath)({
                ...
                callback(result) {
                    ...
                    schemaFormat = (0, schema_parser_1.getSchemaFormat)(value.schemaFormat, detailed.semver.version);
                    parseItems.push({
                        input: {
                            asyncapi: detailed,
                            data: schema,
...
exports.parseSchemasV3 = parseSchemasV3;
function parseSchemaV3(parser, item) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const originalData = item.input.data;
        const parsedData = yield (0, schema_parser_1.parseSchema)(parser, item.input);

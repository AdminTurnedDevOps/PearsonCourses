...
class OpenIDConnectAuth {
    ...
    static decodeJWT(token) {
        ...
        const header = JSON.parse(new TextDecoder().decode(rfc4648_1.base64url.parse(parts[0], { loose: true })));
        const payload = JSON.parse(new TextDecoder().decode(rfc4648_1.base64url.parse(parts[1], { loose: true })));

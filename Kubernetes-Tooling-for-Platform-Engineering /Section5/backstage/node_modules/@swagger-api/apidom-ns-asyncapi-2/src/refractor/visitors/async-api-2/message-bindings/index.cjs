 ...
 * @public
 */
class MessageBindingsVisitor extends (0, _tsMixer.Mixin)(_FixedFieldsVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.element = new _MessageBindings.default();
    this.specPath = (0, _ramda.always)(['document', 'objects', 'MessageBindings']);

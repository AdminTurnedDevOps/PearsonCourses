 ...
 * @public
 */
class OperationBindingsVisitor extends (0, _tsMixer.Mixin)(_FixedFieldsVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.element = new _OperationBindings.default();
    this.specPath = (0, _ramda.always)(['document', 'objects', 'OperationBindings']);

 ...
 * @public
 */
class OperationTraitVisitor extends (0, _tsMixer.Mixin)(_FixedFieldsVisitor.default, _FallbackVisitor.default) {
  constructor(options) {
    super(options);
    this.element = new _OperationTrait.default();
    this.specPath = (0, _ramda.always)(['document', 'objects', 'OperationTrait']);

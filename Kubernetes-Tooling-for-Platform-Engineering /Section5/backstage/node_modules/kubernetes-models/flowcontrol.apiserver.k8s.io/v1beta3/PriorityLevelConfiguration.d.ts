...
import { IIoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationSpec } from "./PriorityLevelConfigurationSpec";
import { IIoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationStatus } from "./PriorityLevelConfigurationStatus";
...
export interface IPriorityLevelConfiguration extends TypeMeta {
     ...
     */
    "spec"?: IIoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationSpec;
    /**
     * `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    "status"?: IIoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationStatus;
}
/**
 * PriorityLevelConfiguration represents the configuration of a priority level.
 */
...
export { IPriorityLevelConfiguration as IIoK8sApiFlowcontrolV1beta3PriorityLevelConfiguration, PriorityLevelConfiguration as IoK8sApiFlowcontrolV1beta3PriorityLevelConfiguration };

...
const { canonicalize_quoted_string, canonicalize, normalize_dot_string, normalize, parse, } = require("../lib/index.js");
...
describe("good addresses pass", function () {
    ...
    it("disposable.style.email.with+symbol@example.com", function () {
        _check("disposable.style.email.with+symbol@example.com", "disposable.style.email.with+symbol", undefined, "example.com", undefined);
    });
